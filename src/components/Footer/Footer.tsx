          ...
          <div className="footer-links-grid">
            <motion.div className="footer-links-group" variants={itemVariants}>
              ...
              <ul className="footer-links-list">
                {['New Products', 'Featured Products', 'Contractor Packs', 'Product Catalog', 'Material Samples'].map((item, index) => (
                  <motion.li 
                    key={index}
                    whileHover={{ x: 5 }}
            ...
            <motion.div className="footer-links-group" variants={itemVariants}>
              ...
              <ul className="footer-links-list">
                {['Residential', 'Commercial', 'Renovation', 'Sustainable Building', 'Architect Solutions'].map((item, index) => (
                  <motion.li 
                    key={index}
                    whileHover={{ x: 5 }}
                    transition={{ type: "spring", stiffness: 300 }}
            ...
            <motion.div className="footer-links-group" variants={itemVariants}>
              ...
              <ul className="footer-links-list">
                {['Installation Guides', 'Material Calculators', 'Project Planning', 'Technical Specifications', 'Safety Data Sheets'].map((item, index) => (
                  <motion.li 
                    key={index}
                    whileHover={{ x: 5 }}
                    transition={{ type: "spring", stiffness: 300 }}
            ...
            <motion.div className="footer-links-group" variants={itemVariants}>
              ...
              <ul className="footer-links-list">
                {['About Us', 'Our Locations', 'Careers', 'Sustainability', 'Press & Media'].map((item, index) => (
                  <motion.li 
                    key={index}
                    whileHover={{ x: 5 }}
                    transition={{ type: "spring", stiffness: 300 }}
        ...
        >
          <div className="footer-legal">
            ...
            <div className="legal-links">
              {['Privacy Policy', 'Terms of Service', 'Contractor Terms'].map((item, index) => (
                <motion.a 
                  key={index}
                  href="#" 
